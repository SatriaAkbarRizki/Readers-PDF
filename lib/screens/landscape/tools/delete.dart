...
import 'package:simplereader/screens/landscape/widget/preview_pdf_grid.dart';
...
class DeleteScreenLandScape extends StatelessWidget {
  static String routeName = '/delete-page';
  String? pdfPath;

  DeleteScreenLandScape({super.key});
