...
class MergeScreenLandScape extends StatelessWidget {
  static String routeName = '/merge-screen';
  List<Pdfmodel> pdfs = [];

  MergeScreenLandScape({super.key});
                            ...
                            builder: (context, state) {
                              ...
                              if (state is ToolsPickPdfTools) {
                                if (state.pdf != null) {
                                  ...
                                  return Stack(
                                    children: [
                                      PreviewPDFLandScape(themes,
                                          state.pdf!.name, state.pdf!.path),
                                      Align(
                              ...
                              return GestureDetector(
                                  ...
                                  child:
                                      PreviewPDFLandScape(themes, null, null));
                            },
                          ),
                        ),
                        BlocProvider(
